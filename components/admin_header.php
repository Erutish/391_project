    ...
    <div class="sidebar">
        ...
        <div class="navbar">
            <ul>
                ...
                <li><a href="add_product.php"><i class="fa-solid fa-bag-shopping"></i>Seller Requests</a></li>
                <li><a href="view_product.php"><i class="fa-solid fa-folder-minus"></i></i></i>view product</a></li>
                <li><a href="user_accounts.php"><i class="fa-solid fa-user"></i></i>accounts</a></li>
