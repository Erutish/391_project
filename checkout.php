        ...
        if(isset($_GET['get_id'])){
            ...
            if ($get_product->rowCount()>0){
                while($fetch_p=$get_product->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $insert_order->execute([uniqid(),$user_id,$seller_id,$name,$number,$email,$address,$address_type,$method,$fetch_p['id'],$fetch_p['price'],1,$dates,$transaction_type]);
            ...
            while($f_cart=$verify_cart->fetch(PDO::FETCH_ASSOC)) {
                ...
                $insert_order->execute([uniqid(),$user_id,$seller_id,$name,$number,$email,$address,$address_type,$method,$f_cart['product_id'],$f_cart['price'],$f_cart['qty'],$dates,$transaction_type]);
            }
            if($insert_order){
