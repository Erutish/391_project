...
<?php
    ...
    if (isset($_POST['delete'])) {
        ...
        $delete_product = $conn->prepare("DELETE FROM `sellers` WHERE id = ?");
...
<head>
    ...
    <title>Acio.com- registered seller page</title>
                    ...
                    <div class="box">
                            ...
                            <form method="POST">
                                ...
                                <div class="flex-btn" style="justify-content: center;">
                                    <button type="submit" name="delete" class="btn" onclick="return confirm('delete this seller');">Delete</button>
                                </div>
                            </form>
                        </div>
