...
if (isset($_COOKIE['admin_id'])) {
    ...
    $seller_product=$conn->prepare("SELECT * FROM `products`");
    $seller_product->execute();
    $total_products= $seller_product->rowCount();

    $seller_orders=$conn->prepare("SELECT * FROM `orders`");
    $seller_orders->execute();
...
<head>
    ...
    <title>Acio.com-admin profile page</title>
