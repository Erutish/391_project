...
<head>
    ...
    <title>Acio.com-search products page</title>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <span><a href="index.php">Home</a><i class="fa-solid fa-angle-right"></i>search products </span>
        </div>
    </div>
                    ...
                    <div class="button">
                        ...
                        <div>
                            ...
                            <?php if($fetch_products['swap']=="enable"){ ?>
                                <a href="swap.php?pid=<?= $fetch_products['id'];?>"  class="fa-solid fa-shuffle"></a>
                            <?php }?>
                        </div>
                    </div>
