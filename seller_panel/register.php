...
if (isset($_POST['submit'])) {
    ...
    if($select_seller->rowCount() >0){
        ...
        if($pass !=$cpass){
            ...
            $insert_seller=$conn->prepare("INSERT INTO sellers(id,name,number,email,password,shop_name,image) VALUES(?,?,?,?,?,?,?)");
            $insert_seller->execute([$id,$name,$number,$email,$cpass,$shop_name,$rename]);
                ...
                <div class="col">
                   <div class="input-field">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" name="shop_name" placeholder="Enter Your Shop name"maxlenght="50" required class="box"/>
                    </div>
                </div>    
            </div>
            <div class="input-field">
